...
## Project Structure (Core vs Extras)

**Core Worlds 2025 analysis files (highlighted on GitHub):**

- `nash_equilibrium.py` – SPNE solver implementation and payoff calculation.
- `composition_scorer.py` – Team composition, lane matchup, and comfort scoring.
- `get_worlds_data.py` – Worlds 2025 database access and player comfort helpers.
- `test_worlds2025_scenarios.py` – Extended role-based champion pools and scenario helpers.
- `test_game1_nash.py` – Game 1 KT vs T1 analysis (Blue BOT+SUP vs Red TOP).
- `test_game2_nash.py` – Game 2 KT vs T1 analysis (Blue MID+BOT vs Red MID).
- `test_game3_nash.py` – Game 3 T1 vs KT analysis (Blue JUNGLE+MID vs Red MID).
- `test_game4_nash.py` – Game 4 T1 vs KT analysis (Blue TOP+MID vs Red TOP).
- `test_game5_nash.py` – Game 5 KT vs T1 analysis (Blue JUNGLE+MID vs Red SUPPORT).
- `requirements.txt` – Python dependencies.
- `lolchampiontags.db` – Main champion + tag database.
- `worlds2025.db` (or equivalent) – Player comfort data for Worlds scenarios.

**Additional utilities and legacy tests (kept as extras):**
...
On GitHub, you can emphasize the **core files** above in the repository description and pin screenshots or PDFs (for example, `GameTheoryResults.pdf`) that were generated by the five game analysis scripts.
